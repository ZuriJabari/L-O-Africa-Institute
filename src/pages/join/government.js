    ...
    <Layout>
      ...
      <section className="relative h-[50vh] bg-gradient-to-r from-[#0B9A9E] to-[#F6911E]">
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center">
          ...
          <p className="text-white/90 text-xl max-w-3xl">
            Collaborate with us to strengthen public sector leadership and drive sustainable development across Africa.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-xl">
              ...
              <p className="text-gray-600">
                Access leadership development programs tailored for public sector officials. Strengthen institutional capacity through targeted training.
              </p>
            </div>
            <div className="bg-gray-50 p-6 rounded-xl">
              ...
              <h3 className="text-xl font-bold mb-4">Policy Insights</h3>
              <p className="text-gray-600">
                Gain valuable insights from our research and thought leadership on governance and public policy issues.
              </p>
            </div>
            <div className="bg-gray-50 p-6 rounded-xl">
              <div className="w-12 h-12 bg-[#0B9A9E]/10 rounded-lg flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">
                Connect with other government leaders, policymakers, and development partners across Africa.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span>Public Sector Leadership Programs</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-[#0B9A9E] mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Governance Training Workshops</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-[#0B9A9E] mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <span>Impact Assessment Studies</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-50 p-6 rounded-xl">
              <h3 className="text-xl font-bold mb-4">Public Service Excellence</h3>
              <p className="text-gray-600 mb-4">
                Learn how our leadership programs have helped transform public service delivery across various government departments.
              </p>
              <a href="/case-studies/public-service" className="text-[#0B9A9E] font-semibold hover:underline">
                Read Case Study →
              </a>
            </div>
            <div className="bg-gray-50 p-6 rounded-xl">
              <h3 className="text-xl font-bold mb-4">Policy Innovation</h3>
              <p className="text-gray-600 mb-4">
                Discover how our research has contributed to innovative policy solutions in different African countries.
              </p>
              <a href="/case-studies/policy" className="text-[#0B9A9E] font-semibold hover:underline">
                Read Case Study →
              </a>
            </div>
          </div>
      ...
      <section className="py-16 bg-[#0B9A9E] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Join our network of government partners and help strengthen public sector leadership across Africa.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a 
              href="/resources/government-brochure" 
